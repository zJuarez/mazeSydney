...
void Priotities::correction(char dir)
{
  switch(dir)
  {
    case 'N':
    {
      ...
      if(tile[x-1][y][z].right() == false || tile[x-1][y][z].left() == false || tile[x-1][y][z].up() == false){}
      else{
    ...
    case 'E':
    {
      ...
      if(tile[x][y+1][z].up() == false || tile[x][y+1][z].right() == false || tile[x][y+1][z].down() == false){}
      else{
    ...
    case 'W':
    {
      ...
      if(tile[x][y-1][z].left() == false || tile[x][y-1][z].up() == false || tile[x][y-1][z].down() == false){}
      else{
      tile[x][y-1][z].exist(0);
      tile[x][y-1][z].pending(0);}
    } break;
