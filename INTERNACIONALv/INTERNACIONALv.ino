...
void setup() {
  ...
  all.maze.setup();
  all.maze.sensors.motors.dispenser.setup();
  all.maze.sensors.motors.setup();
  all.maze.sensors.setup();
  all.setup();


  if(all.maze.sensors.getDistanceOf(4) > 20 && all.maze.sensors.getDistanceOf(4)<200)
  {
    ...
    all.maze.robot.tile[7][7][1].down(1, NULL);
