...
{
    if(sensors.motors.temperatureCelcius(sensors.motors.mlxLeft) >= 25)
      {
        double newD;
      ...
      if(sensors.motors.temperatureCelcius(sensors.motors.mlxRight) >= 25)
      {
        double newD;
...
if(buffer[0] == '4' && dD<18){
    ...
    sensors.motors.escribirLCD("LETRA U", "DERECHA");
       ...
       int aux = sensors.motors.rightCount;
        ...
        sensors.motors.detenerse();
        delay(150);
        sensors.motors.dispenser.dropTwoKitsRight();
        sensors.motors.giro(sensors.motors.de,1);
        sensors.motors.detenerse();
        delay(150);
        sensors.motors.checar();
...
void Algorithm::rightTurn(bool alg)
{
    ...
    if(sensors.getDistanceOf(4) <= 20 && !sensors.motors.bumperControl && ((sensors.motors.girosX>2 || sensors.getDistanceOf(3)==0)))
    {
...
void Algorithm::halfTurn()
{
  ...
  sensors.motors.de=n;
    ...
    if(sensors.getDistanceOf(4) <= 20 && !sensors.motors.bumperControl)
      {
      sensors.motors.atrasSN();
      sensors.motors.girosX=0;
      } 
